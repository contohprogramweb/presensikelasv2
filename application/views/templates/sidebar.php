    ...
    <div class="sidebar" id="sidebar">
        ...
        <nav class="nav flex-column mt-3">
            ...
            <?php if ($role == 'admin'): ?>
                <!-- Admin Menu -->
                <div class="sidebar-header text-white small text-uppercase mt-3 px-3">Master Data</div>
            ...
            <?php elseif ($role == 'guru'): ?>
                <!-- Guru Menu -->
                <div class="sidebar-header text-white small text-uppercase mt-3 px-3">Menu Guru</div>
            ...
            <?php elseif ($role == 'kepsek'): ?>
                <!-- Kepala Sekolah Menu -->
                <div class="sidebar-header text-white small text-uppercase mt-3 px-3">Menu Kepsek</div>
            ...
            <?php elseif ($role == 'siswa'): ?>
                <!-- Siswa Menu -->
                <div class="sidebar-header text-white small text-uppercase mt-3 px-3">Menu Siswa</div>
            ...
            <!-- Common Menu -->
            <div class="sidebar-header text-white small text-uppercase mt-3 px-3">Lainnya</div>
