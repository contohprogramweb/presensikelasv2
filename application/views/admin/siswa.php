<div class="card">
    <div class="card-header d-flex justify-content-between align-items-center">
        ...
        <a href="<?= site_url('admin/import/siswa') ?>" class="btn btn-success"><i class="fas fa-file-import"></i> Import Excel</a>
    </div>
    <div class="card-body">
        <div class="table-responsive">
            <table id="tableSiswa" class="table table-bordered table-striped" style="width: 100%;">
                <thead>
                    <tr>
                        <th>NIS</th>
                        <th>Nama</th>
