                    ...
                    <form method="get" action="<?= site_url('guru/rekap') ?>" class="mb-4">
                        <div class="row g-3">
                            ...
                            <div class="col-md-3 d-flex align-items-end gap-2">
                                ...
                                <?php if (!empty($rekap)): ?>
                                     <a href="<?= site_url('guru/rekap/preview_pdf?kelas='.$filter_kelas.'&start_date='.$filter_start.'&end_date='.$filter_end) ?>" class="btn btn-danger" target="_blank">
                                        <i class="fa fa-files"></i>  PDF
                                    </a>
