...
-- ============================================================
-- Index untuk pencarian presensi berdasarkan tanggal
...
CREATE INDEX idx_log_activity_created ON tb_log_aktivitas(created_at);
